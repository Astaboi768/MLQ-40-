...
module.exports = {
    ...
    onStart: async function ({ api, message, args, event }) {
        ...
        const githubToken = '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'; //add your GitHub token 
        const owner = 'Astaboi768'; //add your GitHub username 
        const repo = 'Astai';  //add your repo name
        const branch = 'main';
